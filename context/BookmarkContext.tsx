...
type BookmarksContextType = {
  ...
  handleUpdateBookmark: (bookmark: Bookmark) => void;
};
...
// Provider wraps the dashboard layout — all children share this state
export const BookmarksProvider = ({ children }: { children: ReactNode }) => {
  ...
  // --- Handlers ---
  // Add new bookmark to top of list — called by AddBookmarkDialog
  ...
  // Replace updated bookmark — called by EditBookmarkDialog
...
// Custom hook — components call this instead of useBookmarks()
export const useBookmarksContext = () => {
  const context = useContext(BookmarksContext);
  if (!context) {
    throw new Error(
      'useBookmarksContext must be used inside BookmarksProvider'
    );
  }
  return context;
};
